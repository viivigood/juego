...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/juegolp.exe: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/juegolp ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/Heroe.o: Heroe.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Heroe.o Heroe.cpp
...
${OBJECTDIR}/PocionCuracion.o: PocionCuracion.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PocionCuracion.o PocionCuracion.cpp
